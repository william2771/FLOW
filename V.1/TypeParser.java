...
{ symbols.put("node_type", val_peek(5).sval);
                                         yyval.sval = "public class Node extends flow.structure.SuperNode {\n  public Node(";
                                         boolean comma = false;
...
{ symbols.put("arc_type", val_peek(4).sval);
                                         yyval.sval = "public class Arc extends flow.structure.SuperArc {\n  public Arc(Node source, Node dest, ";
                                         boolean comma = false;
...
break;
case 13:
//#line 98 "type_parser.y"
{ /* nothing */ }
break;
//#line 474 "TypeParser.java"
